...
namespace A14
{
    internal class Program
    {
        ...
        {
            int[] arr = { 123, 234, 2354, 4563, 9685, 563, 7456, 9874 };
            ...
            //Insertion Sort
            int[]arr1= { 123,234,2354,4563,9685,563,7456,9874 };
            ...
            Print(arr1);
            Console.WriteLine($"Arraysize {arr.Length} Time taken {sw1.Elapsed.TotalMilliseconds} milli seconds(for Insertion Sort)");
            Console.ReadKey();
        }
